...
#knitr::purl("ssm_Stan0.2.2dev.Rmd", output = "ssm_Stan0.2.2dev.R", documentation = 2)
# .libPaths()
...
#===========================================
J = 42#42#40#45#20 #200     # number of firms
N = 4*16#18#15#5#15   #number of (quarterly) observations of a firm
...
file = "SSM0.2.2dev.stan",  # Stan program
...
mcmc_pairs(posterior, np = np, pars = c("d[1]", "d[2]", "d[3]", "mu_alpha", "beta", "mu_base"))#, "theta"))))#, "p[3]"))#,"w", "d"))
...
mcmc_pairs(posterior, np = np, pars = c("w_mu[1]", "w_mu[2]", "sd_y"))#, "sd_season"))#, "w_mu[3]"))#,"w", "d"))
