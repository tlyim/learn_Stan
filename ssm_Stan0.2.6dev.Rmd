...
#knitr::purl("ssm_Stan0.2.6dev.Rmd", output = "ssm_Stan0.2.6dev.R", documentation = 2)
# .libPaths()
...
#===========================================
J = 8#42#40#45#20 #200     # number of firms
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM0.2.6dev.stan",  # Stan program
...
initf2 <- function(chain_id = 1) {
  list(mu_alpha = mu_alpha, beta = beta, theta = theta, #shape = shape,
...
file = "SSM0.2.6dev.stan",  # Stan program
...
#  fit = fit0_debug,   # to save compilation time if the debug model was run
  control = list(adapt_delta = 0.999,#9, 
...
print(fit2, c("mu_u1", "mu_alpha", "beta", "mu_base", #"theta", "sd_base", #"rho", 
...
mcmc_pairs(posterior, np = np, pars = c("mu_alpha", "beta", "sd_y", "mu_base"))#, "theta"))#, "p[3]"))#,"w", "d"))
#mcmc_pairs(posterior, np = np, pars = c("sd_y", "sd_season", "mu_base"))#, "theta"))))#, "p[3]"))#,"w", "d"))
#mcmc_pairs(posterior, np = np, pars = c("g[1]", "g[2]", "mu_alpha", "beta", "mu_base"))#, "theta"))))#, "p[3]"))#,"w", "d"))
#mcmc_pairs(posterior, np = np, pars = c("w[1]", "w[2]", "mu_base"))#, "theta"))))#, "p[3]"))#,"w", "d"))
mcmc_pairs(posterior, np = np, pars = c("d[1]", "d[2]", "d[3]", "mu_alpha", "beta"))#, "theta"))))#, "p[3]"))#,"w", "d"))
mcmc_pairs(posterior, np = np, pars = c("d[1]", "d[2]", "d[3]", "sd_y", "mu_base"))#, "theta"))))#, #mcmc_pairs(posterior, np = np, pars = c("mu_base", "theta", "s[1]", "s[2]", "s[3]"))#, "p[3]"))#,"w", "d"))
...
mcmc_pairs(posterior, np = np, pars = c("ab_err[1]", "ab_err[2]", "ab_mu[1]", "ab_mu[2]"))
...
mcmc_pairs(posterior, np = np, pars = c("p_mu[1]", "p_mu[2]", "sd_y", "mu_base"))#, "sd_season"))#, "p_mu[3]"))#,"w", "d"))
...
mcmc_pairs(posterior, np = np, pars = c("g_mu[1]", "g_mu[2]", "mu_alpha", "beta"))#, "g_mu[3]"))#,"w", "d"))
mcmc_pairs(posterior, np = np, pars = c("g_mu[1]", "g_mu[2]", "sd_y", "mu_base"))#, "sd_season"))#, mcmc_pairs(posterior, np = np, pars = c("g_mu[1]", "g_mu[2]", "d[1]", "d[2]", "d[3]"))#, "g_mu[3]"))#,"w", "d"))


mcmc_pairs(posterior, np = np, pars = c("w_mu[1]", "w_mu[2]", "mu_alpha", "beta"))#, "w_mu[3]"))#,"w", "d"))
mcmc_pairs(posterior, np = np, pars = c("w_mu[1]", "w_mu[2]", "sd_y", "mu_base"))#, "sd_season"))#, "w_mu[3]"))#,"w", "d"))
#mcmc_pairs(posterior, np = np, pars = c("w_mu[1]", "w_mu[2]", "mu_base"))#, "theta"))#, "w_mu[3]"))#,"w", "d"))
#mcmc_pairs(posterior, np = np, pars = c("w_mu[1]", "w_mu[2]", "g[1]", "g[2]"))#, "w_mu[3]"))#,"w", "d"))
#mcmc_pairs(posterior, np = np, pars = c("w_mu[1]", "w_mu[2]", "w[1]", "w[2]"))#, "w_mu[3]"))#,"w", "d"))
mcmc_pairs(posterior, np = np, pars = c("w_mu[1]", "w_mu[2]", "d[1]", "d[2]", "d[3]"))#, "w_mu[3]"))#,"w", "d"))
#mcmc_pairs(posterior, np = np, pars = c("w_mu[1]", "w_mu[2]", "s[1]", "s[2]", "s[3]"))#, "w_mu[3]"))#,"w", "d"))
