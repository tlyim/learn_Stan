...
N = 16*7  # number of (yearly) observations of a firm
...
# Simulate SSM data
simu_fit <- stan(model_code = simu_SSM@model_code, data=simu_SSM_data, iter=1, #seed=987,  
...
#  fit = fit0_debug,   # to save compilation time if the debug model was run
  control = list(adapt_delta = 0.999, max_treedepth = 11),    # adjust when there're divergent transitions after warmup
