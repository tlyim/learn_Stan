...
N = 4*30#18#15#5#15   #number of (quarterly) observations of a firm
...
mcmc_pairs(posterior, np = np, pars = c("p_mu[1]", "p_mu[2]", "mu_alpha", "beta"))#, "p_mu[3]"))#,"w", "d"))
mcmc_pairs(posterior, np = np, pars = c("p_mu[1]", "p_mu[2]", "sd_y", "sd_season"))#, "p_mu[3]"))#,"w", "d"))
mcmc_pairs(posterior, np = np, pars = c("p_mu[1]", "p_mu[2]", "mu_base", "theta"))#, "p_mu[3]"))#,"w", "d"))
mcmc_pairs(posterior, np = np, pars = c("p_mu[1]", "p_mu[2]", "g[1]", "g[2]"))#, "p_mu[3]"))#,"w", "d"))
mcmc_pairs(posterior, np = np, pars = c("p_mu[1]", "p_mu[2]", "w[1]", "w[2]"))#, "p_mu[3]"))#,"w", "d"))
mcmc_pairs(posterior, np = np, pars = c("p_mu[1]", "p_mu[2]", "d[1]", "d[2]", "d[3]"))#, "p_mu[3]"))#,"w", "d"))
#mcmc_pairs(posterior, np = np, pars = c("p_mu[1]", "p_mu[2]", "s[1]", "s[2]", "s[3]"))#, "p_mu[3]"))#,"w", "d"))
    ...
    # mcmc_pairs(posterior, np = np, pars = c("s[1]", "s[2]", "s[3]", "g[1]", "g[2]", "g[3]"))#,"w", "d"))
        ...
        # mcmc_pairs(posterior, np = np, pars = c("mu_base", "theta", "p_mu[1]", "p_mu[2]"))#, "p_mu[3]"))#,"w", "d"))
        ...
        #                                         "p_mu[1]", "p_mu[2]"))#, "p_mu[3]"))#,"w", "d"))
        # mcmc_pairs(posterior, np = np, pars = c("p_mu[1]", "p_mu[2]", #"p_mu[3]", 
        #                                         "g[1]", "g[2]"))#, "g[3]"))#,"w", "d"))
