...
#knitr::purl("ssm_Stan0.4.3dev.Rmd", output = "ssm_Stan0.4.3dev.R", documentation = 2)
# .libPaths()
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM0.4.3dev.stan",  # Stan program
...
file = "SSM0.4.3dev.stan",  # Stan program
...
#mcmc_pairs(posterior, np = np, pars = c("w_mu[1]", "w_mu[2]", "p_mu[1]", "p_mu[2]", "p0[1]"))
