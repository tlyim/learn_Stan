---
title: "Multivariate AR State-Space Models - MARSS models"
...
# Simulate data using MARSSsimulate()
```{r}
...
Define a MARSS model (form="marxss")
```{r}
...
```{stan output.var=misreport, eval=T}
                ...
                // b ~ cauchy(0, 2.5); // common prior for each b[K]
                  ...
                  rho ~ inv_gamma(5,20);    // (5,30) (5,5) (8.91924, 34.5805);                    rho_T = 5.5
                  alpha ~ gamma(3,1); // gamma(1.5,0.5)  normal(0, 3);     // (0, 2)  (0,1)    alpha_T = 3
