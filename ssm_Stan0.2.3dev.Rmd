...
#knitr::purl("ssm_Stan0.2.3dev.Rmd", output = "ssm_Stan0.2.3dev.R", documentation = 2)
# .libPaths()
...
N = 4*25#18#15#5#15   #number of (quarterly) observations of a firm
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM0.2.3dev.stan",  # Stan program
...
file = "SSM0.2.3dev.stan",  # Stan program
...
#  fit = fit0_debug,   # to save compilation time if the debug model was run
  control = list(adapt_delta = 0.995,#9, 
