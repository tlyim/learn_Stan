...
#knitr::purl("ssm_Stan2.0.Rmd", output = "ssm_Stan2.0.R", documentation = 2)
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM2.0.stan",  # Stan program
