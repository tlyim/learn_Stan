...
#knitr::purl("ssm_Stan0.2.4dev.Rmd", output = "ssm_Stan0.2.4dev.R", documentation = 2)
# .libPaths()
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM0.2.4dev.stan",  # Stan program
...
file = "SSM0.2.4dev.stan",  # Stan program
...
mcmc_pairs(posterior, np = np, pars = c("g_mu[1]", "g_mu[2]", "sd_y", "mu_base"))#, "sd_season"))#, 
mcmc_pairs(posterior, np = np, pars = c("g_mu[1]", "g_mu[2]", "d[1]", "d[2]", "d[3]"))#, "g_mu[3]"))#,"w", "d"))
