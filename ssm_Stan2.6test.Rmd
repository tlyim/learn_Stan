...
print(fit2, c("mu_alpha", "beta", "mu_u1", "rho_ST", "rho_LT", #"delta", 
...
pairs_stan(1, fit2, c("mu_u1", "rho_ST", "rho_LT", "sd_pi", "p"))#"delta", 
pairs_stan(2, fit2, c("mu_u1", "rho_ST", "rho_LT", "sd_pi", "p"))#"delta", 
