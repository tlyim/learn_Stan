...
// priors 
	sd_y ~ cauchy(0, 5);//0.14);  //sd_y_init Inverse-gamma (alpha, beta) has mean = beta/(alpha - 1) if alpha > 1
//	sd_y ~ normal(0, 10);//0.14);  //sd_y_init Inverse-gamma (alpha, beta) has mean = beta/(alpha - 1) if alpha > 1
//	sd_gamma ~ normal(0, 100);//50 //2.5);//0.2);//1);//0.1);//0.06//0.04);  //sd_gamma_init Inverse-gamma (alpha, beta) has mean = beta/(alpha - 1) if alpha > 1
	sd_gamma ~ cauchy(0,5);//50 //2.5);//0.2);//1);//0.1);//0.06//0.04);  //sd_gamma_init Inverse-gamma (alpha, beta) has mean = beta/(alpha - 1) if alpha > 1
	sd_omega ~ cauchy(0,5);//50 //5.0);//0.5);//1);// 0.09);//0.07);  //sd_omega_init Inverse-gamma (alpha, beta) has mean = beta/(alpha - 1) if alpha > 1
//	sd_omega ~ normal(0, 100);//50 //5.0);//0.5);//1);// 0.09);//0.07);  //sd_omega_init Inverse-gamma (alpha, beta) has mean = beta/(alpha - 1) if alpha > 1
//  sd_base ~ normal(0, 100);//15 //10 //20 //3.5//1.9//0.7); //0.2);  //sd_base_init Inverse-gamma (alpha, beta) has mean = beta/(alpha - 1) if alpha > 1
  sd_base ~ cauchy(0, 5);//15 //10 //20 //3.5//1.9//0.7); //0.2);  //sd_base_init Inverse-gamma (alpha, beta) has mean = beta/(alpha - 1) if alpha > 1

//  alpha01 ~ beta(3*alpha01_init, 3*(1-alpha01_init));
//  beta ~ beta(5.5*beta_init, 5.5*(1-beta_init));
  g ~ normal(0, 10); //0.2); // g_init
  w ~ normal(0, 10); //0.2); //1);  // w_init
