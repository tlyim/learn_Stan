...
#knitr::purl("ssm_Stan0.4.9dev.Rmd", output = "ssm_Stan0.4.9dev.R", documentation = 2)
.libPaths()
...
#===========================================
J = 80#5#42#40#45#20 #200     # number of firms
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM0.4.9dev.stan",  # Stan program
...
file = "SSM0.4.9dev.stan",  # Stan program
...
mcmc_pairs(posterior, np = np, pars = c("sd_season", "mu_season[1]", "mu_season[2]", "mu_season[3]"))
mcmc_pairs(posterior, np = np, pars = c("sd_season", "theta", "mu_u1", "sd_y"))
mcmc_pairs(posterior, np = np, pars = c("mu_season[1]", "theta", "mu_u1", "sd_y"))
mcmc_pairs(posterior, np = np, pars = c("mu_season[2]", "theta", "mu_u1", "sd_y"))
mcmc_pairs(posterior, np = np, pars = c("mu_season[3]", "theta", "mu_u1", "sd_y"))

mcmc_pairs(posterior, np = np, pars = c("sd_season", "gw_mu[1]", "gw_mu[2]", "gw_mu[3]", "gw_mu[4]"))
mcmc_pairs(posterior, np = np, pars = c("mu_season[1]", "gw_mu[1]", "gw_mu[2]", "gw_mu[3]", "gw_mu[4]"))
mcmc_pairs(posterior, np = np, pars = c("mu_season[2]", "gw_mu[1]", "gw_mu[2]", "gw_mu[3]", "gw_mu[4]"))
mcmc_pairs(posterior, np = np, pars = c("mu_season[3]", "gw_mu[1]", "gw_mu[2]", "gw_mu[3]", "gw_mu[4]"))

mcmc_pairs(posterior, np = np, pars = c("sd_season", "gw_mu[5]", "gw_mu[6]", "ab_mu[1]", "ab_mu[2]"))
mcmc_pairs(posterior, np = np, pars = c("mu_season[1]", "gw_mu[5]", "gw_mu[6]", "ab_mu[1]", "ab_mu[2]"))
mcmc_pairs(posterior, np = np, pars = c("mu_season[2]", "gw_mu[5]", "gw_mu[6]", "ab_mu[1]", "ab_mu[2]"))
mcmc_pairs(posterior, np = np, pars = c("mu_season[3]", "gw_mu[5]", "gw_mu[6]", "ab_mu[1]", "ab_mu[2]"))

mcmc_pairs(posterior, np = np, pars = c("sd_season", "p_mu[1]", "p_mu[2]", "p_mu[3]"))
mcmc_pairs(posterior, np = np, pars = c("mu_season[1]", "p_mu[1]", "p_mu[2]", "p_mu[3]"))
mcmc_pairs(posterior, np = np, pars = c("mu_season[2]", "p_mu[1]", "p_mu[2]", "p_mu[3]"))
mcmc_pairs(posterior, np = np, pars = c("mu_season[3]", "p_mu[1]", "p_mu[2]", "p_mu[3]"))

mcmc_pairs(posterior, np = np, pars = c("sd_season", "d[1]", "d[2]", "d[3]"))
mcmc_pairs(posterior, np = np, pars = c("mu_season[1]", "d[1]", "d[2]", "d[3]"))
mcmc_pairs(posterior, np = np, pars = c("mu_season[2]", "d[1]", "d[2]", "d[3]"))
mcmc_pairs(posterior, np = np, pars = c("mu_season[3]", "d[1]", "d[2]", "d[3]"))
