...
#knitr::purl("ssm_Stan0.1.6test.Rmd", output = "ssm_Stan0.1.6test.R", documentation = 2)
...
#===========================================
J = 32#40#40#45#20 #200     # number of firms
N = 4*12#15#15#5#15   #number of (quarterly) observations of a firm
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM0.1.6test.stan",  # Stan program
...
file = "SSM0.1.6test.stan",  # Stan program
...
#====================================================
    ...
    # rho = 5,  
    # s = c(0.4, 0.7, 0.5) 
# p = c(0.37, 3.0, 0.13)# # soft-clipping  rho=5 #old: p = c(-3.0, 0.13, -0.37) [rho=5]; 
# g = c(0.5, 0.5, 1)   #old: g = c(0.5, -0.5, 1);     #[old] g = c(0.5, -0.8, 2.5)
# w = c(3.7, 4.3, 0.6)    #old: w = c(-3.7, 4.3, 0.6)    #[old] w = c(-3.5, 7, 2) 
    # d = c(0.05, 0.7, 0.25) 
# mu_season = c(-0.12, -0.06, 0.15), sd_season = 0.1; sd_pi = 0.05, 
  # mu_base = -1.6, sd_base = 0.15; sd_y = 0.15, sd_gamma = 0.05, sd_omega = 0.1, 
