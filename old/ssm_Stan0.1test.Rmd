...
#knitr::purl("ssm_Stan0.0.Rmd", output = "ssm_Stan0.0.R", documentation = 2)
...
#===========================================
J = 40#150#45#20 #200     # number of firms
N = 4*15#20#5#15   #number of (quarterly) observations of a firm
