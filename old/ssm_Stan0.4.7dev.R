...
#knitr::purl("ssm_Stan0.4.7dev.Rmd", output = "ssm_Stan0.4.7dev.R", documentation = 2)
.libPaths()
...
#===========================================
J = 80#10#5#42#40#45#20 #200     # number of firms
...
theta = 0.07 # real EM's LT impact on alpha[j,n]
...
s = c(0, 0.7, 0.5)# # soft-clipping  rho=5
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM0.4.7dev.stan",  # Stan program
...
file = "SSM0.4.7dev.stan",  # Stan program
...
print(fit2, c(
              "mu_u1", 
              "mu_alpha", "beta", #"rho", 
              "sd_y", "theta", #"sd_base", #"mu_base", #"sd_season", "mu_season", 
              #"s",
              "p",
              "g", 
              "w", 
