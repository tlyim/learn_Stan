...
#===========================================
J = 50#5#15#10#5#42#40#45#20 #200     # number of firms
...
all crossovers
```{r} 
mcmc_pairs(posterior, np = np, pars = c("g_mu[1]", "g_mu[2]", "g_mu[3]", "w_mu[1]", "w_mu[2]", "w_mu[3]"))
mcmc_pairs(posterior, np = np, pars = c("g_mu[1]", "g_mu[2]", "g_mu[3]", "p_mu[1]", "p_mu[2]", "p_mu[3]"))
mcmc_pairs(posterior, np = np, pars = c("g_mu[1]", "g_mu[2]", "g_mu[3]", "ab_mu[1]", "ab_mu[2]", "sd_y"))
mcmc_pairs(posterior, np = np, pars = c("g_mu[1]", "g_mu[2]", "g_mu[3]", "d[1]", "d[2]", "d[3]"))
mcmc_pairs(posterior, np = np, pars = c("w_mu[1]", "w_mu[2]", "w_mu[3]", "p_mu[1]", "p_mu[2]", "p_mu[3]"))
mcmc_pairs(posterior, np = np, pars = c("w_mu[1]", "w_mu[2]", "w_mu[3]", "ab_mu[1]", "ab_mu[2]", "sd_y"))
mcmc_pairs(posterior, np = np, pars = c("w_mu[1]", "w_mu[2]", "w_mu[3]", "d[1]", "d[2]", "d[3]"))
...
mcmc_pairs(posterior, np = np, pars = c("g_mu[1]", "w_mu[1]", "p_mu[1]", "d[1]", "ab_mu[1]", "ab_mu[2]"))
mcmc_pairs(posterior, np = np, pars = c("g_mu[2]", "w_mu[2]", "p_mu[2]", "d[2]", "ab_mu[1]", "ab_mu[2]"))
mcmc_pairs(posterior, np = np, pars = c("g_mu[3]", "w_mu[3]", "p_mu[3]", "d[3]", "ab_mu[1]", "ab_mu[2]"))

mcmc_pairs(posterior, np = np, pars = c("g_mu[1]", "w_mu[1]", "p_mu[1]", "d[1]", "sd_y", "mu_u1"))
mcmc_pairs(posterior, np = np, pars = c("g_mu[2]", "w_mu[2]", "p_mu[2]", "d[2]", "sd_y", "mu_u1"))
mcmc_pairs(posterior, np = np, pars = c("g_mu[3]", "w_mu[3]", "p_mu[3]", "d[3]", "sd_y", "mu_u1"))
```


# g
```{r} 
mcmc_pairs(posterior, np = np, pars = c("g_err[1]", "g_err[2]", "g_err[3]", "w_err[1]", "w_err[2]", "w_err[3]"))
mcmc_pairs(posterior, np = np, pars = c("g_err[1]", "g_err[2]", "g_err[3]", "p_err[1]", "p_err[2]", "p_err[3]"))
mcmc_pairs(posterior, np = np, pars = c("w_err[1]", "w_err[2]", "w_err[3]", "p_err[1]", "p_err[2]", "p_err[3]"))


mcmc_pairs(posterior, np = np, pars = c("g_sd[1]", "g_sd[2]", "g_sd[3]", "w_sd[1]", "w_sd[2]", "w_sd[3]"))
mcmc_pairs(posterior, np = np, pars = c("g_sd[1]", "g_sd[2]", "g_sd[3]", "p_sd[1]", "p_sd[2]", "p_sd[3]"))
mcmc_pairs(posterior, np = np, pars = c("w_sd[1]", "w_sd[2]", "w_sd[3]", "p_sd[1]", "p_sd[2]", "p_sd[3]"))
