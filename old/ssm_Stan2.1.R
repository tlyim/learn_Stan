...
#knitr::purl("ssm_Stan2.1.Rmd", output = "ssm_Stan2.1.R", documentation = 2)
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM2.1.stan",  # Stan program
