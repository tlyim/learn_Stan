...
d = c(0.7, 0.25, 0.05) # fractional reversal of prior-period manipluation by accruals
L = length(d)
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM1.8.stan",  # Stan program
...
plot(params.df$iter, params.df$sd_temp, pch=16, cex=0.8, #col=c_dark, 
