...
J = 10#100 #00#50    # number of firms
...
pairs1A <- pairs_stan(1, fit2, c("alpha", "beta", "sd_y", "sd_gamma", "g"))
pairs4A <- pairs_stan(4, fit2, c("alpha", "beta", "sd_y", "sd_gamma", "g"))
pairs1B <- pairs_stan(1, fit2, c("sd_base", "sd_omega", "w", "d"))
pairs4B <- pairs_stan(4, fit2, c("sd_base", "sd_omega", "w", "d"))
