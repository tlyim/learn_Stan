...
mcmc_pairs(posterior, np = np, pars = c("mu_alpha", "beta", "mu_base"))#, "theta"))#, "p[3]"))#,"w", "d"))
mcmc_pairs(posterior, np = np, pars = c("sd_y", "sd_season", "mu_base"))#, "theta"))))#, "p[3]"))#,"w", "d"))
mcmc_pairs(posterior, np = np, pars = c("g[1]", "g[2]", "mu_base"))#, "theta"))))#, "p[3]"))#,"w", "d"))
mcmc_pairs(posterior, np = np, pars = c("w[1]", "w[2]", "mu_base"))#, "theta"))))#, "p[3]"))#,"w", "d"))
mcmc_pairs(posterior, np = np, pars = c("d[1]", "d[2]", "d[3]", "mu_base"))#, "theta"))))#, "p[3]"))#,"w", "d"))
