...
#knitr::purl("ssm_Stan0.1.7test.Rmd", output = "ssm_Stan0.1.7test.R", documentation = 2)
...
#===========================================
J = 40#40#45#20 #200     # number of firms
N = 4*15#15#5#15   #number of (quarterly) observations of a firm
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM0.1.7test.stan",  # Stan program
...
file = "SSM0.1.7test.stan",  # Stan program
