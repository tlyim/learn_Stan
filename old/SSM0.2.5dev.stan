...
parameters {
  real mu_u1;
//===============================================================================
            vector<lower=0,upper=1> [2] ab_mu; // vector of means for correlated coeffs in w
...
//mu_alpha ~ normal(0.5, 0.5);//normal(0, 1);//student_t(3, 0, 1);//exponential(2);//
//  beta ~ normal(0.5, 0.5);
//===============================================================================
...
//  g ~ normal(0, 1);//student_t(4, 0, 1);//student_t(3, 0, 5);//normal(0, 1);//10);//0); //0.2); // g_init
        ...
        g_err ~ normal(0, 1); // implies:  w_raw ~ multi_normal(w_mu, quad_form_diag(w_L * w_L', w_sd));
//===============================================================================
