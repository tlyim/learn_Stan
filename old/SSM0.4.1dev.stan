...
//  p ~ normal(0, 1);//student_t(4, 0, 1);//5);
        p_mu ~ normal(0, 1);
        p_sd ~ normal(0, 0.25);//2);
        p_L ~ lkj_corr_cholesky(2);
        p_err ~ normal(0, 0.25); // implies:  w_raw ~ multi_normal(w_mu, quad_form_diag(w_L * w_L', w_sd));
//===============================================================================
...
//!!!    w ~ normal(0, 1);//student_t(4, 0, 1);//student_t(3, 0, 5);//normal(0, 5);//10);//0); //0.2); //1);  // w_init
        //w0 ~ normal(0, 1);//2);
        //w_mu ~ normal(0, 1);
        //w_sd ~ normal(0, 0.05);//2);
        //w_L ~ lkj_corr_cholesky(2);
        //w_err ~ normal(0, 0.1); // implies:  w_raw ~ multi_normal(w_mu, quad_form_diag(w_L * w_L', w_sd));
//===============================================================================
