...
J = 45#20#45#20 #200     # number of firms
N = 4*30#15#5#15 #10 #20  #number of (quarterly) observations of a firm
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM0.0test.stan",  # Stan program
...
file = "SSM0.0test.stan",  # Stan program
...
plot(params.df$iter, params.df$sd_season, pch=16, cex=0.8, #col=c_dark, 
      xlab="Iteration")#, ylab="log(tau)", ylim=c(-6, 4))
plot(params.df$iter, params.df$mu_season[1], pch=16, cex=0.8, #col=c_dark, 
      xlab="Iteration")#, ylab="log(tau)", ylim=c(-6, 4))
