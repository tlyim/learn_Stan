...
J = 10#15#20 #200     # number of firms
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM2.4test.stan",  # Stan program
...
=======
n_chains = 8
>>>>>>> 0608cdf0886ec7c0eb1fb1d978a6cf50e0f00b8a
...
file = "SSM2.4test.stan",  # Stan program
...
pairs_stan(2, fit2, c("rho_ST", "rho_LT", "delta", "sd_pi", "p"))
...
# p = c(-4, -1, 3.5)
    ...
    # d = c(0.05, 0.7, 0.25) # fractional reversal of prior-period manipluation by accruals
# mu_season = c(-0.03, -0.06, 0.05)
# sd_pi = 0.05, # sd of underlying unbiased figures is likely to be industry-specific/bus-model specific
    # sd_season = 0.02, sd_y = 0.08, sd_gamma = 0.05, sd_omega = 0.1, sd_base = 0.1
