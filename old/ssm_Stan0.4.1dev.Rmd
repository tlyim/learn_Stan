...
#knitr::purl("ssm_Stan0.4.1dev.Rmd", output = "ssm_Stan0.4.1dev.R", documentation = 2)
# .libPaths()
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM0.4.1dev.stan",  # Stan program
...
file = "SSM0.4.1dev.stan",  # Stan program
...
mcmc_pairs(posterior, np = np, pars = c("p_L[2,1]", "p_L[2,2]", "p_err[1]", "p_err[2]"))
...
# mcmc_pairs(posterior, np = np, pars = c("p0", "p[1]", "p[2]", "ab_mu[1]", "ab_mu[2]"))
# mcmc_pairs(posterior, np = np, pars = c("p0", "p[1]", "p[2]", "ab_sd[1]", "ab_sd[2]"))
# mcmc_pairs(posterior, np = np, pars = c("p0", "p[1]", "p[2]", "ab_L[2,1]", "ab_L[2,2]"))
# mcmc_pairs(posterior, np = np, pars = c("p0", "p[1]", "p[2]", "ab_err[1]", "ab_err[2]"))
# mcmc_pairs(posterior, np = np, pars = c("p0", "p[1]", "p[2]", "mu_u1", "sd_y"))
# mcmc_pairs(posterior, np = np, pars = c("p0", "p[1]", "p[2]", "mu_alpha", "beta"))
