...
#knitr::purl("ssm_Stan2.5.Rmd", output = "ssm_Stan2.5.R", documentation = 2)
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM2.5test.stan",  # Stan program
...
file = "SSM2.5test.stan",  # Stan program
...
print(fit2, c("mu_alpha", "beta", "rho_ST", "rho_LT", #"delta", 
...
pairs_stan(1, fit2, c("rho_ST", "rho_LT", "sd_pi", "p"))#"delta", 
pairs_stan(2, fit2, c("rho_ST", "rho_LT", "sd_pi", "p"))#"delta", 
...
#====================================================
    # mu_alpha = 0.04; mu_alpha01 = 0.52 # intercept of the AR(1) processs of the underlying unbiased figure
    # beta = 0.6  # slope parameter of the AR(1) processs of the underlying unbiased figure
# rho_LT = 0.02, rho_ST = 0.1, delta = 0.65,    
    # p = c(-4, -1, 3.5)
    # g = c(0.5, -0.8, 2.5)
    # w = c(-3.5, 7, 2)
    # d = c(0.05, 0.7, 0.25) # fractional reversal of prior-period manipluation by accruals
# mu_season = c(-0.03, -0.06, 0.05)
# sd_season = 0.02, sd_y = 0.08  # sd of underlying unbiased figures is likely to be industry-specific/bus-model specific
# sd_pi = 0.05, sd_gamma = 0.05, sd_omega = 0.1, sd_base = 0.1  #1/999   #   // for debugging only
