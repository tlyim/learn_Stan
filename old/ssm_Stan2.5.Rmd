...
J = 200 #00#50    # number of firms
N = 5*4#4#2 #4 #7 number of (yearly) observations of a firm
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM2.5.stan",  # Stan program
...
#  chains = 8,#1,#8,             # default is 4 Markov chains
#  cores = 8,
