...
J = 1#5#15 #00#50    # number of firms
...
d = c(0.8, 0.05, 0.15) # fractional reversal of prior-period manipluation by accruals
L = length(d)
...
#  seed = 555, 
  ...
  iter = 5000,#4000,#7000,#12000, #500 #2000,            # total number of iterations per chain
  warmup = 2000,#500,          # number of warmup iterations per chain
