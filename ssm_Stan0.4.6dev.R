...
#knitr::purl("ssm_Stan0.4.6dev.Rmd", output = "ssm_Stan0.4.6dev.R", documentation = 2)
.libPaths()
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM0.4.6dev.stan",  # Stan program
...
file = "SSM0.4.6dev.stan",  # Stan program
...
mcmc_pairs(posterior, np = np, pars = c("gw_mu[3]", "gw_mu[4]", "gw_sd[3]", "gw_err[3]"))
mcmc_pairs(posterior, np = np, pars = c("gw_mu[3]", "gw_mu[4]", "gw_sd[4]", "gw_err[4]"))
mcmc_pairs(posterior, np = np, pars = c("gw_mu[3]", "gw_mu[4]", "mu_u1", "sd_y"))
mcmc_pairs(posterior, np = np, pars = c("gw_mu[3]", "gw_mu[4]", "d[1]", "d[2]", "d[3]"))

mcmc_pairs(posterior, np = np, pars = c("gw_mu[3]", "gw_mu[4]", "gw_mu[1]", "gw_mu[2]"))
mcmc_pairs(posterior, np = np, pars = c("gw_mu[3]", "gw_mu[4]", "gw_sd[1]", "gw_sd[2]"))
mcmc_pairs(posterior, np = np, pars = c("gw_mu[3]", "gw_mu[4]", "gw_err[1]", "gw_err[2]"))

mcmc_pairs(posterior, np = np, pars = c("gw_mu[3]", "gw_mu[4]", "gw_mu[5]", "gw_mu[6]"))
mcmc_pairs(posterior, np = np, pars = c("gw_mu[3]", "gw_mu[4]", "gw_sd[5]", "gw_sd[6]"))
mcmc_pairs(posterior, np = np, pars = c("gw_mu[3]", "gw_mu[4]", "gw_err[5]", "gw_err[6]"))

mcmc_pairs(posterior, np = np, pars = c("gw_mu[3]", "gw_mu[4]", "p_mu[1]", "p_mu[2]", "p_mu[3]"))
mcmc_pairs(posterior, np = np, pars = c("gw_mu[3]", "gw_mu[4]", "p_sd[1]", "p_sd[2]", "p_sd[3]"))
mcmc_pairs(posterior, np = np, pars = c("gw_mu[3]", "gw_mu[4]", "p_err[1]", "p_err[2]", "p_err[3]"))

mcmc_pairs(posterior, np = np, pars = c("gw_mu[3]", "gw_mu[4]", "ab_mu[1]", "ab_mu[2]"))
mcmc_pairs(posterior, np = np, pars = c("gw_mu[3]", "gw_mu[4]", "ab_sd[1]", "ab_sd[2]"))
mcmc_pairs(posterior, np = np, pars = c("gw_mu[3]", "gw_mu[4]", "ab_err[1]", "ab_err[2]"))
