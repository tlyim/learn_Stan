...
#===========================================
J = 32#45#20 #200     # number of firms
N = 4*12#5#15   #number of (quarterly) observations of a firm
...
print(fit2, c("mu_u1", "mu_alpha", "beta", #"rho_raw", "rho", 
              "alpha_ratio_raw", "alpha_ratio", "p", "sd_pi",  #"rho_ST", 
...
pairs_stan(1, fit2, c("mu_u1", "alpha_ratio_raw", "beta", "sd_y", "sd_season", "mu_season"))#"season_raw"))#, 
pairs_stan(1, fit2, c("alpha_ratio_raw", "beta", "sd_pi", "p"))#"season_raw"))#, "rho_raw", 
...
plot(params.df$iter, params.df$sd_pi, pch=16, cex=0.8, #col=c_dark, 
      xlab="Iteration")#, ylab="log(tau)", ylim=c(-6, 4))
plot(params.df$iter, params.df$alpha_ratio_raw, pch=16, cex=0.8, #col=c_dark, 
