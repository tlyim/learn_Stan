...
#knitr::purl("ssm_Stan0.1.2test.Rmd", output = "ssm_Stan0.1.2test.R", documentation = 2)
...
#===========================================
J = 60#32#45#20 #200     # number of firms
...
rho_ST = 0.1
rho = 2#5  # ; =0 will remove the LT impact
...
#p = c(-4, 3)
#p = c(-4.5, -1, 3.5)
p = c(-2, 6.5, -7.7)#-4.5)  # from p_raw; p[I] is intercept coeff. 
I = length(p)
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM0.1.2test.stan",  # Stan program
...
file = "SSM0.1.2test.stan",  # Stan program
...
# [new] p = c(-2, 6.5, -7.7); [old] p = c(-4.25, -1, 3.5); 
    # g = c(0.5, -0.8, 2.5)
    # w = c(-3.5, 7, 2)
    # d = c(0.05, 0.7, 0.25) 
