...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM2.3test.stan",  # Stan program
...
fit1 <- stan(
  ...
  file = "SSM2.3test.stan",  # Stan program
...
pairs_stan(4, fit2, c("mu_alpha", "beta", "sd_y", "sd_gamma", "g"))
pairs_stan(1, fit2, c("rho_ST", "delta", "sd_pi", "p"))
pairs_stan(4, fit2, c("rho_ST", "delta", "sd_pi", "p"))
