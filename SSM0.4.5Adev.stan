...
//  beta ~ normal(0.5, 0.5);
  ab_mu ~ normal(0, 0.25);//normal(0, 1);//
...
//  p ~ normal(0, 1);//student_t(4, 0, 1);//5);
  p_mu[1] ~ normal(0, 0.25);//1);//student_t(3,0,1);//4, 0, 1);// 
  p_mu[2:3] ~ normal(0, 0.5);//1);//student_t(3,0,1);//4, 0, 1);// 
...
/*
//===============================================================================
  gw_mu ~ normal(0, 0.5);//1);
  gw_sd ~ normal(0, 0.1);//0.2);
  gw_L ~ lkj_corr_cholesky(2);
  gw_err ~ normal(0, 0.1); //0.1); implies:  w_raw ~ multi_normal(w_mu, quad_form_diag(w_L * w_L', w_sd));
*/
//===============================================================================
