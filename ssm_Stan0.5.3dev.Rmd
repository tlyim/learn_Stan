...
#===========================================
J = 40#90#60#42#40#45#20 #200     # number of firms
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM0.5.3dev.stan",  # Stan program
...
n_iter = 2#1450#1300#950#2000#3000
...
initf2 <- function(chain_id = 1) {
  list(mu_alpha = mu_alpha, beta = beta, theta = theta, ab_mu = ab_mu, #shape = shape,
       s = s, p = p, g = g, w = w, d = d, 
       s = s, p = p, g = g, w = w, d = d, 
       mu_season = mu_season, sd_season = sd_season,
...
file = "SSM0.5.3dev.stan",  # Stan program
...
mcmc_pairs(posterior, np = np, pars = c("g_mu[1]", "g_mu[2]", "theta", "mu_season[1]"))
mcmc_pairs(posterior, np = np, pars = c("g_mu[1]", "g_mu[2]", "mu_season[2]", "mu_season[3]"))
mcmc_pairs(posterior, np = np, pars = c("w_mu[1]", "w_mu[2]", "w_mu[3]", "theta", "mu_season[1]"))
mcmc_pairs(posterior, np = np, pars = c("w_mu[1]", "w_mu[2]", "w_mu[3]", "mu_season[2]", "mu_season[3]"))

mcmc_pairs(posterior, np = np, pars = c("p[1]", "p[2]", "p[3]", "theta", "mu_season[1]"))
mcmc_pairs(posterior, np = np, pars = c("p[1]", "p[2]", "p[3]", "mu_season[2]", "mu_season[3]"))
...
mcmc_pairs(posterior, np = np, pars = c("g_mu[1]", "g_mu[2]", "w_mu[1]", "w_mu[2]", "w_mu[3]"))
mcmc_pairs(posterior, np = np, pars = c("g_mu[1]", "g_mu[2]", "p[1]", "p[2]", "p[3]"))
mcmc_pairs(posterior, np = np, pars = c("g_mu[1]", "g_mu[2]", "d[1]", "d[2]", "d[3]"))
mcmc_pairs(posterior, np = np, pars = c("ab_mu[1]", "ab_mu[2]", "p[1]", "p[2]", "p[3]"))
