...
#knitr::purl("ssm_Stan0.3.0dev.Rmd", output = "ssm_Stan0.3.0dev.R", documentation = 2)
# .libPaths()
...
#===========================================
J = 10#5#42#40#45#20 #200     # number of firms
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM0.3.0dev.stan",  # Stan program
...
file = "SSM0.3.0dev.stan",  # Stan program
...
mcmc_pairs(posterior, np = np, pars = c("sd_y", "ab_mu[1]", "ab_mu[2]", "ab_sd[1]", "ab_sd[2]"))
mcmc_pairs(posterior, np = np, pars = c("sd_y", "ab_err[1]", "ab_err[2]"))


mcmc_pairs(posterior, np = np, pars = c("mu_alpha", "beta", "sd_y"))#, "mu_base"))#, "theta"))#, #,"w", "d"))
...
mcmc_pairs(posterior, np = np, pars = c("d[1]", "d[2]", "d[3]", "sd_y"))#, "mu_base"))#, "theta"))))#, 
