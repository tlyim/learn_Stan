...
J = 25#20 #200     # number of firms
N = 4*10#5#15 #10 #20  #number of (quarterly) observations of a firm
...
rho_ST = 0.1
rho_LT = 1.5#5  # ; =0 will remove the LT impact
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM2.7test.stan",  # Stan program
...
print(fit2, c("mu_alpha", "beta", "mu_u1", "rho_LT", #"rho_ST", #"mu_u1", #"delta", 
...
pairs_stan(1, fit2, c("mu_u1", "rho_LT", "sd_pi", "p"))#"delta", "rho_ST", 
pairs_stan(2, fit2, c("mu_u1", "rho_LT", "sd_pi", "p"))#"delta", "mu_u1", "rho_ST", 
...
#====================================================
    ...
    # beta = 0.6  
# mu_u1 = 0.3, rho_LT = 5, rho_ST = 0.1, #delta = 0.65,    
    # p = c(-4.25, -1, 3.5)
    # g = c(0.5, -0.8, 2.5)
    # w = c(-3.5, 7, 2)
    # d = c(0.05, 0.7, 0.25) 
