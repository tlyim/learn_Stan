...
sd_temp = 1/999   #   // for debugging only
sd_omega = 0.01
sd_gamma = 0.02
sd_omega = 0.01
...
#                 stepsize = 0.05, #0.05, #0.01
                 max_treedepth = 14),    # adjust when there're divergent transitions after warmup
...
names(params.df) <- gsub("]", "", names(params.df), fixed = TRUE)
params.df$iter <- 1:2000

par(mar = c(4, 4, 0.5, 0.5))
plot(params.df$iter, params.df$sd_omega, col=c_dark, pch=16, cex=0.8,
