...
#knitr::purl("ssm_Stan0.2dev.Rmd", output = "ssm_Stan0.2dev.R", documentation = 2)
# .libPaths()
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM0.2dev.stan",  # Stan program
...
file = "SSM0.2dev.stan",  # Stan program
...
mcmc_pairs(posterior, np = np, pars = c("g[1]", "g[2]", "g[3]", "d[1]", "d[2]", "d[3]"))#,"w", "d"))
