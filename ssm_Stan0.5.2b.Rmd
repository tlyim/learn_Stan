...
#knitr::purl("ssm_Stan0.5.2b.Rmd", output = "ssm_Stan0.5.2b.R", documentation = 2)
...
#===========================================
J = 150#60#42#40#45#20 #200     # number of firms
N = 4*25#25#30#18#15#5#15   #number of (quarterly) observations of a firm
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM0.5.2b.stan",  # Stan program
...
```{r}
#stan_rdump(names(SSM_data), file = "SSM_data_J150.dat", envir = list2env(SSM_data)) 
...
file = "SSM0.5.2b.stan",  # Stan program
