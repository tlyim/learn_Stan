...
J = 3#00#50    # number of firms
N = 16*2#2 #4 #7 number of (yearly) observations of a firm


#sd_c_init = 0.1  #0.01
sd_gamma = 0.02
sd_y = 0.04  # sd of underlying unbiased figures is likely to be industry-specific / business model specific
...
X.l <- data.frame(gvkey = rep(1:J,N),                   
                  #constant = rep(1, J*N),
                  indiv_integ = rnorm(J*N, integrity, 0.3), 
...
simu_fit <- stan(#model_code = simu_SSM@model_code,
                 file = "simu_SSM1.1.stan",  # Stan program
...
#  seed = 555,
  ...
  iter = 4000,#7000,#12000, #500 #2000,            # total number of iterations per chain
